...
int add_table_index( uint32_t indices_sector, FILE *file, const char *table_name, uint32_t data_sector, struct TableIndexArray *index_table);
int update_table_sector_link( uint32_t indices_sector, FILE *file, const char *table_name, uint32_t new_data_sector, struct TableIndexArray *index_table);
int remove_table_index( uint32_t indices_sector, FILE *file, const char *table_name, struct TableIndexArray *index_table);
